...
In addition, I added a countdown timer for the popular "pomodoro" productivity technique and, of course, I made sure to include the current battery percentage, date, and time.
